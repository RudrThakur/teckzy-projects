  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> _widgetOptions = <Widget>[
      ...
      SettingsOption(
        ...
        onTapEditProfile: () {
          if (widget.prefs.getString(Dbkeys.isPINsetDone) != currentUserNo ||
            ...
            ChatController.authenticate(
                _cachedModel!, getTranslated(context, 'auth_needed'),
                        ...
                        child: Scaffold(
                          bottomNavigationBar: FancyBottomNavigation(
                            ...
                            tabs: [
                              ...
                              TabData(iconData: Icons.book, title: "Status"),
                              TabData(iconData: Icons.phone, title: "Calls"),
                              TabData(
                          ...
                          body: PageTransitionSwitcher(
                            ...
                            child: observer.isCallFeatureTotallyHide == false
