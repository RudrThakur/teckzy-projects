...
final fiberchatBlue = new Color(0xFF1984F0);
final fiberchatDeepGreen = new Color(0xFF1984F0);
final fiberchatLightGreen = new Color(0xFF1984F0);
final fiberchatgreen = new Color(0xFF1984F0);
...
const SplashBackgroundSolidColor = Color(0xFF1984F0);
...
const GiphyAPIKey =
    'WHS1srX4wm1v9RjthRQ0rDI4iWBOs32d'; // Grab it from: https://developers.giphy.com/
